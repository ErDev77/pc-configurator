...
import { AlertCircle, ChevronDown, ChevronUp, Trash } from 'lucide-react'
...
export default function AddComponentPage() {
  ...
  const handleSubmit = async () => {
    try {
      ...
      const endpoint = savedComponentId ? `/api/products/${savedComponentId}` : '/api/products'
      ...
      if (!savedComponentId && responseData.id) {
        ...
        toast.success('Продукт успешно создан! Теперь вы можете добавить совместимости.')
      } else {
              ...
              <div>
                ...
                <div className="mb-6">
                  <label className="flex items-center cursor-pointer">
                    ...
                    />
                    <span className="ml-2 text-white text-sm">Скрыть товар</span>
                  </label>
                </div>
              </div>
            ...
            {savedComponentId ? (
              <>
                ...
                >
                  ...
                  {showCompatibility ? <ChevronUp className="h-5 w-5" /> : <ChevronDown className="h-5 w-5" />}
                </button>
              ...
              <div className="bg-[#202529] p-6 rounded-2xl border border-gray-700 shadow-lg">
                <div className="text-center py-10">
                  ...
                  <h3 className="text-xl text-white font-medium mb-2">Сначала сохраните компонент</h3>
                  <p className="text-gray-400">
                    После создания продукта вы сможете добавить информацию о совместимости с другими компонентами
                  </p>
                </div>
              </div>
            )}
